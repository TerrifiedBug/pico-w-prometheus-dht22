...
def test_validation():
    ...
    print("[PASS] Normal validation test passed")
    ...
    print("[PASS] Empty input validation test passed")
...
def test_metrics_format():
    ...
    print(f"[PASS] Labels formatted correctly: {labels}")
...
def test_prometheus_labels():
    ...
    print("[PASS] Prometheus label sanitization test passed")
...
def test_file_operations():
    ...
    print("[PASS] Valid JSON file test passed")
    ...
    print("[PASS] Corrupted JSON handling test passed")
